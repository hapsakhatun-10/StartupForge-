...
const links = [
    { name: "Overview", href: "/dashboard/collabarator", icon: LayoutDashboard },
    { name: "Browse Opportunities", href: "/dashboard/collabarator/opportunities", icon: Briefcase },
    { name: "My Applications", href: "/dashboard/collabarator/applications", icon: ClipboardList },
    { name: "Profile", href: "/dashboard/collabarator/profile", icon: User },
];

export default function CollabaratorLayout({ children }) {
