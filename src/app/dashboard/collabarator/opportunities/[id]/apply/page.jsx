        ...
        return (
            <div className="flex items-center justify-center min-h-[70vh] px-4">
                <div className="text-center">
                    ...
                    <Link href="/dashboard/collabarator/opportunities" className="text-indigo-600 hover:text-indigo-700 font-medium">
            ...
            <div className="flex items-center justify-center min-h-[70vh] px-4">
                <div className="text-center max-w-md">
                    ...
                    <div className="flex gap-3 justify-center">
                        <Link href="/dashboard/collabarator/opportunities"
                        ...
                        <Link href="/dashboard/collabarator/applications"
                            className="inline-flex items-center gap-2 px-5 py-2.5 border border-slate-300 text-slate-700 font-semibold rounded-xl hover:bg-slate-50 transition-colors"
                        >
                            My Applications
                        </Link>
                    </div>
