...
export default function BrowseOpportunities() {
    ...
    return (
        <div className="p-6 sm:p-8 max-w-6xl">
            <div className="mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Browse Opportunities</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Find startups looking for collaborators.</p>
            </div>

            {opportunities.length === 0 ? (
                <div className="text-center py-20">
                    <Briefcase className="h-12 w-12 text-slate-300 dark:text-slate-600 mx-auto mb-4" />
                    <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300">No opportunities yet</h3>
                    ...
                    {opportunities.map((opp) => (
                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                ...
                                <ExternalLink className="h-4 w-4 text-slate-300 dark:text-slate-600 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors shrink-0" />
                            </div>
