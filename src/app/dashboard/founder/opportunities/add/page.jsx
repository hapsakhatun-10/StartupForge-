...
export default function AddOpportunityPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError("");
        try {
            const res = await fetch("http://localhost:5000/opportunity", {
                method: "POST",
    ...
    return (
        <div className="p-6 sm:p-8 max-w-2xl">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-1">Add Opportunity</h1>
            <p className="text-sm text-slate-500 mb-8">Post a new opportunity for your startup.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                    ...
                    <input type="text" required value={form.startup_id}
                        ...
                        placeholder="Paste your startup ID"
                    />
                </div>
