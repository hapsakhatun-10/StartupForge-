...
export default function AddStartupPage() {
    ...
    return (
        <div className="p-6 sm:p-8 max-w-2xl">
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-1">Add Startup</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-8">Fill in the details to register your startup.</p>
