        ...
        return (
            <div className="min-h-[70vh] flex items-center justify-center px-4">
                <div className="text-center max-w-sm">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Startup not found</h2>
                ...
                >
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm">
                            ...
                            {startup.description && (
                                <div className="mb-8">
                                        <h2 className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-white uppercase tracking-wider mb-3">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    {startup.funding_stage ? (
                                        <span className="inline-block px-3 py-1 text-sm font-semibold rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 ring-1 ring-inset ring-amber-300 dark:ring-amber-700">
                                            {startup.funding_stage}
                                        </span>
                                    ) : (
                        ...
                        <div className="mt-6 lg:col-span-3">
                            ...
                            >
                                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 sm:p-6 shadow-sm">
                                    <h3 className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-5">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {opportunities.map((opp) => (
                                            <div
                                                key={opp._id}
                                                className="border border-slate-100 dark:border-slate-700/50 rounded-xl p-4 hover:border-violet-200 dark:hover:border-violet-500/50 hover:shadow-sm transition-all"
                                            >
                                                ...
                                                {opp.required_skills && (
                                                    <div className="flex flex-wrap gap-1.5 mb-2">
                                                        {opp.required_skills.split(",").map((skill) => (
                                                            <span
                                                                key={skill.trim()}
                                                                className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-[10px] font-medium rounded-md"
                                                            >
                                                                {skill.trim()}
                                                            </span>
                                                        ))}
